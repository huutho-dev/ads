// Copyright 2019 com.sdk.ads.observer.Google LLC
//
...
package com.its.admob.lib.nativeView.google.tem;
...
import com.its.admob.lib.R;

/**
 * Base class for a template view. *
 */
public class GGNativeView extends FrameLayout {

  private int templateType;
  private GGNativeStyle styles;
  ...
  private static final String RECYCLER_VIEW_TEMPLATE = "rev_template";

  public GGNativeView(Context context) {
    super(context);
  }

  public GGNativeView(Context context, @Nullable AttributeSet attrs) {
    super(context, attrs);
    initView(context, attrs);
  }

  public GGNativeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr);
    initView(context, attrs);
  }

  public GGNativeView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    super(context, attrs, defStyleAttr, defStyleRes);
    initView(context, attrs);
  }

  public void setStyles(GGNativeStyle styles) {
    this.styles = styles;
    this.applyStyles();
  }
  ...
  public String getTemplateTypeName() {
    ...
    }else if (templateType == R.layout.gnt_item_rv_template_view){
      return RECYCLER_VIEW_TEMPLATE;
    }
    return "";
  }
  ...
  private void initView(Context context, AttributeSet attributeSet) {
    ...
    TypedArray attributes =
        context.getTheme().obtainStyledAttributes(attributeSet, R.styleable.GGNativeView, 0, 0);

    try {
      templateType =
          attributes.getResourceId(
              R.styleable.GGNativeView_gnt_template_type,
